...
Grid views look broken

Social sharing looks sad

Workflow:

Scan the Published content with no featured image table.
...
On small to medium sites this is fine. On huge sites:
...
Detection of unused image sizes for old thumbnail dimensions

A dry run checklist for scripted cleanups

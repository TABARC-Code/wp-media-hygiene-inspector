...
- Its ID.  
- The relative file path WordPress believes in.  
...
- Files that exist.  
- Files that are above the size threshold, by default 5 MB.  
...
- Treat this as a list of suspects, not a list of safe deletions.  
...
If the Media Library was treated like a real asset repository instead of a dumping ground, this plugin would not be necessary. I know i know.
